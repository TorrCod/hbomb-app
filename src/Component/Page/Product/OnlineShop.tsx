...
import CartCountBtn from '../../../Feature/CartCountBtn';
...
export const OnlineShopCartItem = (props:OnlineShopCartItem_props)=>{
  ...
  const {url:imgSrc,price:itemPrice,name} = props.item;
    ...
    <div className="onlineshopCart-item">
      ...
      <div className='onlineshopCart-item-info'>
        <h3 className='onlineshopCart-numberofitem'>
          <span>
            <CartCountBtn type='decrement' item={props.item} />
          </span>
          x{itemCount}
          <span>
            <CartCountBtn type='increment' item={props.item} />
          </span>
        </h3>
